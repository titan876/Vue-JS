...
var arr = ['black', 'red', 'yellow', 'white', 'pink', 'blue', 'orange', 'green'];
...
console.log(min, max);
var randomDig = Math.random() * 100 + 1;
randomDig = +randomDig.toFixed(2);
console.log(randomDig);
var randomDig2 = Math.random() * 10 + 1;
randomDig2 = Math.round(randomDig2);
console.log(randomDig2);
var result = parseFloat((0.6 + 0.7).toFixed(1));
console.log(result);
var stToNum = parseInt('100$');
console.log(stToNum);